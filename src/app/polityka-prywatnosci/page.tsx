  ...
  const sections: DocSection[] = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p>
            2. Administrator przykłada ogromną wagę do ochrony prywatności i
            poufności danych osobowych użytkowników korzystających z serwisu
            MałeNaklejki. Dane osobowe są przetwarzane zgodnie z przepisami
            Rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia
            27 kwietnia 2016 r. (RODO) oraz ustawy o ochronie danych osobowych.
          </p>
        </div>
      ),
    },
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="bg-card border border-border/80 p-5 rounded-2xl flex flex-col gap-2">
              ...
              <ul className="text-sm space-y-1 pl-9">
                <li>
                  <strong className="text-primary">Zakres danych:</strong> imię,
                  nazwisko, adres e-mail, numer telefonu, adres dostawy (ulica,
                  kod pocztowy, miasto, kraj), dane do faktury (NIP, nazwa
                  firmy, adres).
                </li>
                <li>
                  <strong className="text-primary">Cel:</strong> przyjęcie
                  zamówienia, weryfikacja płatności, produkcja
                  spersonalizowanych naklejek oraz dostawa pod wskazany adres.
                </li>
              </ul>
            </div>
            ...
            <div className="bg-card border border-border/80 p-5 rounded-2xl flex flex-col gap-2">
              ...
              <p className="text-sm pl-9">
                Płatności online realizowane są przez zewnętrznego operatora{" "}
                <strong>Przelewy24</strong>. Administrator nie przechowuje i nie
                ma bezpośredniego dostępu do danych kart płatniczych ani haseł
                bankowych.
              </p>
            </div>
            ...
            <div className="bg-card border border-border/80 p-5 rounded-2xl flex flex-col gap-2">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h4 className="font-black text-foreground text-sm">
                  Przetwarzanie grafik użytkownika (art. 6 ust. 1 lit. b RODO)
                </h4>
              </div>
              <p className="text-sm pl-9">
                Wgrywane przez Klienta grafiki są zapisywane w chmurze{" "}
                <strong>Firebase Storage</strong> (serwery Google w UE). Pliki
                te są używane wyłącznie do wyznaczenia linii cięcia, edycji
                obrazu w kreatorze oraz wydrukowania zamówionych naklejek.
              </p>
            </div>
            ...
            <div className="bg-card border border-border/80 p-5 rounded-2xl flex flex-col gap-2">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h4 className="font-black text-foreground text-sm">
                  Obowiązki prawne i podatkowo-księgowe (art. 6 ust. 1 lit. c
                  RODO)
                </h4>
              </div>
              <p className="text-sm pl-9">
                <strong className="text-primary">Cel:</strong> wystawianie
                faktur, prowadzenie księgowości oraz przechowywanie dokumentacji
                podatkowej zgodnie z prawem polskim.
              </p>
            </div>
            ...
            <div className="bg-card border border-border/80 p-5 rounded-2xl flex flex-col gap-2">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h4 className="font-black text-foreground text-sm">
                  Ustalenie, dochodzenie i obrona przed roszczeniami (art. 6
                  ust. 1 lit. f RODO)
                </h4>
              </div>
              <p className="text-sm pl-9">
                <strong className="text-primary">Cel:</strong> prawnie
                uzasadniony interes Administratora polegający na ochronie
                własnych praw.
              </p>
            </div>
            ...
            <div className="bg-card border border-border/80 p-5 rounded-2xl flex flex-col gap-2">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h4 className="font-black text-foreground text-sm">
                  Analiza ruchu i statystyki (art. 6 ust. 1 lit. a RODO -
                  dobrowolna zgoda)
                </h4>
              </div>
              <ul className="text-sm space-y-1 pl-9">
                <li>
                  ...
                  identyfikator online (Client ID), adres IP, przybliżona
                  lokalizacja geograficzna, parametry techniczne urządzenia i
                  przeglądarki, zachowanie w serwisie.
                </li>
                <li>
                  <strong className="text-primary">Cel:</strong> badanie ruchu
                  na stronie, optymalizacja kreatora naklejek pod kątem
                  użyteczności oraz weryfikacja skuteczności działań
                  marketingowych przy użyciu narzędzi Google Analytics 4 oraz
                  Vercel Analytics.
                </li>
              </ul>
            </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            1. Dane związane z realizacją zamówienia przechowywane są przez
            okres niezbędny do realizacji umowy, a po tym czasie przez okres
            przedawnienia roszczeń (co do zasady 6 lat) oraz okres wymagany
            przepisami prawa podatkowego (5 lat od końca roku podatkowego).
          </p>
          <p>
            2. Pliki graficzne (projekty naklejek) wgrane przez użytkownika są
            automatycznie usuwane lub archiwizowane do usunięcia w okresie 30
            dni od momentu zrealizowania zamówienia, chyba że przechowywanie
            jest konieczne do obsługi ewentualnych reklamacji.
          </p>
          <p>
            3. Dane przetwarzane w celach analitycznych lub technicznych (w tym
            pliki cookies) przechowywane są zgodnie z czasem ich wygaśnięcia
            zapisanym w plikach cookies (szczegóły w Polityce Cookies).
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            W celu prawidłowego działania serwisu i realizacji zamówień dane
            osobowe mogą być przekazywane zaufanym podmiotom trzecim:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-muted/40 border border-border/80 p-4 rounded-2xl flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Bezpieczne przechowywanie danych w bazie danych oraz projektów
                  graficznych w chmurze Storage (serwery w UE).
                </p>
              </div>
            </div>
            ...
            <div className="bg-muted/40 border border-border/80 p-4 rounded-2xl flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Bezpieczne procesowanie transakcji płatniczych, przelewów
                  internetowych, BLIK oraz kart płatniczych.
                </p>
              </div>
            </div>
            ...
            <div className="bg-muted/40 border border-border/80 p-4 rounded-2xl flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Firmy spedycyjne odpowiedzialne za generowanie etykiet
                  przewozowych oraz fizyczną dostawę paczki.
                </p>
              </div>
            </div>
            ...
            <div className="bg-muted/40 border border-border/80 p-4 rounded-2xl flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Podmioty świadczące dla nas certyfikowane usługi księgowe,
                  prawne oraz wsparcie IT.
                </p>
              </div>
            </div>
            ...
            <div className="bg-muted/40 border border-border/80 p-4 rounded-2xl flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Dostawca usług hostingowych oraz anonimowego narzędzia do
                  statystyk i analityki wydajnościowej Vercel Analytics.
                </p>
              </div>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            1. Serwis wykorzystuje pliki cookies (ciasteczka) w celu zapewnienia
            prawidłowego działania (np. przechowywanie koszyka, sesja
            użytkownika), analizy ruchu oraz dopasowania treści.
          </p>
          <p>
            2. Szczegółowe informacje o rodzajach stosowanych plików cookies,
            ich celach oraz metodach zarządzania nimi (w tym wycofania zgody)
            znajdują się w dedykowanej{" "}
            <Link
              href="/pliki-cookies"
          ...
          <p>
            3. Serwis nie stosuje zautomatyzowanego podejmowania decyzji, w tym
            profilowania wywołującego skutki prawne dla użytkowników.
          </p>
        </div>
      ),
    },
