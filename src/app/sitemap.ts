...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = ["", "/kontakt", "/o-nas", "/regulamin", "/polityka-prywatnosci", "/pliki-cookies", "/blog", "/zamow-projekt", "/alternatywa-dla-sticker-mule-i-stickerapp", "/naklejki-dla-firm", "/naklejki-foliowe", "/fotonaklejki", "/naklejki-die-cut", "/slownik-naklejek"];
