...
const COMPARISON: { feature: string; us: string; them: string }[] = [
  ...
  {
    feature: "Dostawa",
    us: "Paczkomat lub kurier w Polsce, 2-3 dni robocze",
...
const ADVANTAGES: { icon: React.ElementType; title: string; text: string }[] = [
  ...
  },
  {
    ...
    text: "Wgraj zdjęcie z telefonu, a kreator sam usunie tło i wytnie naklejkę po kształcie. Nie masz grafiki? Opisz pomysł, a narzędzia AI (np. ChatGPT lub Gemini) wygenerują gotowy obraz.",
  },
  {
    icon: ShieldCheck,
      ...
      <main className="flex-1 pt-6 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
        ...
        <section className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { value: "2-3 dni", label: "Realizacja" },
          ...
          <ol className="space-y-4">
            {[
              ...
              },
              {
                ...
                text: "Obejrzyj realistyczny podgląd 3D gotowego arkusza, zapłać BLIK-iem lub przez Przelewy24, a naklejki wyślemy do paczkomatu w 2-3 dni robocze.",
              },
            ].map((step, i) => (
              <li
                key={step.title}
        ...
        <section className="mt-12 bg-white dark:bg-[#003a3b] rounded-3xl border border-border/40 p-6 sm:p-10 shadow-sm text-center space-y-4">
          ...
          <p className="text-sm sm:text-base text-muted-foreground font-medium leading-relaxed max-w-2xl mx-auto">
            ...
            na arkuszu. Naklejki będą gotowe w 2-3 dni robocze za stałe 49,00 zł
          ...
          <div className="flex flex-wrap justify-center gap-2 pt-2 text-xs font-bold text-muted-foreground">
            <span className="inline-flex items-center gap-1.5">
              <Clock className="w-3.5 h-3.5 text-primary" /> Realizacja 2-3 dni
            </span>
            <span className="inline-flex items-center gap-1.5">
